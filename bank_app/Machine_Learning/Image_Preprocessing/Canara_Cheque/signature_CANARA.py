...
def signature_extraction_CANARA(image_path):
    ...
    # cropping the image
    sig_Cropped = image_blured[600:840, 1800:2300]
    ...
    for c in cnts_sig:
        ...
        if 50 < h < 250 and 50 < w < 400:
            ...
            cv2.imwrite(
                r'C:\Users\ADEM\Desktop\ESPRIT_Education\4er\PI DS\image preprocessing\CANARA cheque\signature image CANARA\sig_CANARA.png',
                sig_extracted)
